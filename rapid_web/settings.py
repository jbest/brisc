"""
Django settings for rapid_web project.
...
import os
#import secret # Create a file secret.py which contains #SECRET_KEY = 'your_secrect_key'
...
SECRET_KEY = 'NOT_secret_do_not_use_in_production!'
